...
import com.karyaprestasi.fishpal.databinding.FragmentVerifiedEmailBinding
...
class VerifiedEmailFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (bundle!=null){
            moveFromLoginToVerifyEmail = bundle.getBoolean(Constants.MOVE_FROM_LOGIN_TO_VERIFIED_EMAIL, false)
        }
        ...
        when(v?.id){
            ...
            R.id.btnResendCode -> {
                ...
                user?.sendEmailVerification()?.addOnSuccessListener {
                    ...
                    Log.d(Constants.TAG, "onFailure: Resend email not sent " + it.message)
                }
            }
        }
    }

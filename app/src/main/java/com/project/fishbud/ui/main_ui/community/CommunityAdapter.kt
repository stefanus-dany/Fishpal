...
//
//
//class CommunityAdapter(mContext: Context, onItemClick: OnItemClick) : RecyclerView.Adapter<CommunityAdapter.CourseViewHolder>() {
//    private var dataIkan = ArrayList<CommunityEntity>()
//    private val mCallback = onItemClick
//
//    fun setdataIkan(data: List<CommunityEntity>?) {
//        if (data == null) return
//        this.dataIkan.clear()
...
//                    val dataIkanToCart = CommunityEntity(
//                        data.idProduk,
//                        data.namaIkan,
//                        data.harga,
//                        data.tokoIkan,
